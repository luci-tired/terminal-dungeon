...
namespace TDMain
{
    class MainClass
    {
        ...
        public static string SelectNumb()
        {
            ...
            if (_key == ConsoleKey.D1)
            {
                return "1";
            }

            else if (_key == ConsoleKey.D2)
            {
                return "2";
            }

            else if (_key == ConsoleKey.D3)
            {
                return "3";
            }

            else if (_key == ConsoleKey.D4)
            {
                return "4";
            }

            else if (_key == ConsoleKey.D5)
            {
                return "5";
            }

            else if (_key == ConsoleKey.D6)
            {
                return "6";
            }

            else if (_key == ConsoleKey.D7)
            {
                return "7";
            }

            else if (_key == ConsoleKey.D8)
            {
                return "8";
            }

            else if (_key == ConsoleKey.D9)
            {
                return "9";
            }

            else if (_key == ConsoleKey.D0)
            {
                return "0";
            }
